...
const BLOG_CATALOG_MAP: Record<string, readonly string[]> = {
  ...
  'eu-low-value-parcel-duty-kakobuy-spreadsheet-2026': ['shoes', 't-shirts', 'bags'],
  'eu-ics2-pre-arrival-data-kakobuy-parcels-2026': ['shoes', 'electronics', 'bags'],
  'eu-gpsr-product-safety-kakobuy-buyers-2026': ['electronics', 'perfume', 'accessories'],
  'eu-product-identifiers-pid-spreadsheet-buyers-2026': ['shoes', 'bags', 't-shirts'],
  'cn23-electronic-customs-data-kakobuy-parcels-2026': ['t-shirts', 'hoodies', 'accessories'],
