...
export const es: SpreadsheetPageCopy = {
  title: 'Cómo usar Kakobuy Spreadsheet — guía de enlaces y QC',
  description:
    'Guía paso a paso de Kakobuy Spreadsheet para 2026: explora carriles, copia URLs de Taobao, Weidian o 1688, fija expectativas QC y pega enlaces en Kakobuy antes de enviar.',
  keywords:
...
<strong>kakobuy-cn.com no aloja</strong> la parrilla SKU en vivo; publicamos espejos editoriales para que entiendas por qué desaparecen filas, por qué los screenshots inflan el QC y dónde la matemática de flete internacional se separa de las celdas optimistas.`,
  heroTags: [
    ...
    'UX de descubrimiento por carril',
    'Filas refrescadas por temporada',
    'Glosario embebido para novatos',
    'Pagos solo vía Kakobuy',
  ],
...
<strong>El ritmo de actualización importa:</strong> los sellers reorganizan álbumes, matan variantes o renombran batches más rápido que envejecen los screenshots de Discord. Ante la duda, vuelve al <strong><a href="{ml}" target="_blank" rel="noopener noreferrer">browse del catálogo</a></strong> antes de confiar en exportaciones viejas.`,
  ...
  previewFiltersLabel: 'Filtros calientes ahora:',
  previewCards: [
    {
      title: 'Silueta runner heritage',
      category: 'Zapatillas',
      priceHint: 'Rango ~34 $',
      tagsLine: 'QC still si el seller adjunta · esencial del carril · batch muy comentado',
    },
    {
      title: 'Tee boxy acid wash',
      category: 'Camisetas',
      priceHint: 'Rango ~15 $',
      tagsLine: 'Rotación veraniega · fit oversize · restock frecuente',
    },
    {
      title: 'Hoodie polar con doble cremallera',
      category: 'Sudaderas / jerseys',
      priceHint: 'Rango ~29 $',
      tagsLine: 'QC warehouse crítico · cremalleras gruesas · ojo al DIM',
    },
    {
      title: 'Sling crossbody modular',
      category: 'Bolsos',
      priceHint: 'Rango ~23 $',
      tagsLine: 'Carril EDC · hardware de correa · grosor de padding variable',
    },
    {
      title: 'Jersey de cancha ventilado',
      category: 'Jersey',
      priceHint: 'Rango ~18 $',
      tagsLine: 'Tensión de malla cambia · gráficos de sponsor frágiles · comparar anuncios',
    },
    {
      title: 'Auriculares wireless low-latency',
      category: 'Electrónica',
      priceHint: 'Rango ~27 $',
      tagsLine: 'Lotería de driver · leer capturas de reviews · validar estuche de carga',
    },
  ],
  whyTitle: 'Por qué el descubrimiento “catálogo primero” sigue ganando',
  whyItems: [
    {
      title: 'Saltar de carril vence ruleta ciega de keywords',
      body: 'Los tiles abren browse filtrado al estilo spreadsheet en vez de adivinar SEO Taobao.',
    },
    {
      title: 'Migas de QC cuando el seller coopera',
      body: 'Algunas filas incrustan stills del vendedor — orientación útil, nunca reemplazo de capturas Kakobuy en almacén.',
    },
    {
      title: 'Separación visual por vertical de armario',
      body: 'Calzado, capas de punto, bolsos, electrónica e impulsos de fragancia viven en cubos distintos para escaneo veloz.',
    },
    {
      title: 'URLs amigables al portapapeles',
      body: 'Las filas heredan validación comunitaria; pasas menos noches verificando hops muertos antes de pegar en Kakobuy.',
    },
    {
      title: 'Comparar batches sin arqueología Discord',
      body: 'Previsualiza varias siluetas o bandas de precio antes de abrir infinitas pestañas Chrome.',
    },
    {
      title: 'Onboarding en lenguaje llano',
      body: 'Junta este ensayo con Cómo comprar cuando el slang de Discord se sienta cerrado.',
    },
  ],
  howTitle: 'Chuleta de flujo',
  howSteps: [
    {
      title: 'Paso 1 — Elige un carril',
      body: 'Arranca en calzado, punto, accesorios, electrónica o búsqueda libre dentro del chrome de browse.',
    },
    {
      title: 'Paso 2 — Vetea el anuncio',
      body: 'Confirma grillas de variante, tablas de medidas, QC del seller (si hay). Copia la URL canónica del artículo — no el splash de la tienda.',
    },
    {
      title: 'Paso 3 — Empuja por Kakobuy',
      body: 'Pega en el flujo de adquisición Kakobuy, liquida cargos domésticos y espera escaneos inbound.',
    },
    {
      title: 'Paso 4 — Audita fotos de almacén',
      body: 'Amplía costuras, paneles, suelas, pintura — impugna diferencias antes de liberar export.',
    },
    {
      title: 'Paso 5 — Reserva flete internacional',
...
Si la jerga sigue opaca, suma este texto con <a href="{howToUrl}">Cómo comprar</a> para no copiar URLs hero de tienda por error.`,
  ...
  faqs: [
    {
      q: 'Define Kakobuy Spreadsheet sin hype?',
      aHtml: `Una <strong>columna vertebral de catálogo curada por humanos</strong> para URLs de marketplace chino. Este dominio explica estrategia; inventario realtime está en la <a href="{ml}" target="_blank" rel="noopener noreferrer">vista spreadsheet del catálogo</a>; el comercio ocurre en <a href="{kakobuyUrl}" target="_blank" rel="noopener noreferrer">Kakobuy</a>.`,
    },
    {
      q: '¿Pueden seguir los novatos?',
      aHtml: `Sí — apila esta página con <a href="{howToUrl}">Cómo comprar</a> para clics UI reales y <a href="{newsUrl}">Noticias y guías</a> cuando quieras avisos Kakobuy espejados.`,
    },
    {
      q: '¿Qué verticales aparecen más?',
      aHtml: `Zapatillas, capas streetwear, bolsos, accesorios, jerseys, compras compulsivas de belleza, experimentos electrónicos más pestañas “misc” — disponibilidad fluye con temporadas del seller.`,
    },
    {
      q: '¿El QC de hoja sustituye fotos de almacén?',
      aHtml: `Nunca. El QC inline sigue siendo <strong>marketing del seller</strong>; la fotografía inbound de Kakobuy es la capa ejecutora.`,
    },
    {
      q: '¿Por qué no saltarse spreadsheets del todo?',
      aHtml: `Puedes — pero raíles curados comprimen tiempo de validación y ahorran noches persiguiendo hops Weidian muertos.`,
    },
    {
  ...
  bulletsTitle: 'Antes de salir del sitio',
  bullets: [
    'Cero carritos aquí — nunca cables fondos a kakobuy-cn.com.',
  ...
  newsLinkLabel: 'Mesa de noticias →',
};
