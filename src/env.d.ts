...
interface ImportMetaEnv {
  readonly PUBLIC_KAKOBUY_SPREADSHEET_URL?: string;
  /** Overrides Discord invite used by TOP banner `/join/discord` redirect */
  readonly PUBLIC_KAKOBUY_DISCORD_URL?: string;
  /** Override intro video source (default Kakobuy CDN MP4 in `src/consts.ts`); HTTPS URL or same-origin path to an MP4 */
